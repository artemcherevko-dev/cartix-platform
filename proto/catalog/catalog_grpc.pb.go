...
const (
	...
	Catalog_ResetData_FullMethodName     = "/Catalog/ResetData"
)
...
type CatalogClient interface {
	...
	ResetData(ctx context.Context, in *ResetDataReq, opts ...grpc.CallOption) (*ResetDataRes, error)
}
...
func (c *catalogClient) ResetData(ctx context.Context, in *ResetDataReq, opts ...grpc.CallOption) (*ResetDataRes, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(ResetDataRes)
	err := c.cc.Invoke(ctx, Catalog_ResetData_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type CatalogServer interface {
	...
	ResetData(context.Context, *ResetDataReq) (*ResetDataRes, error)
...
func (UnimplementedCatalogServer) ResetData(context.Context, *ResetDataReq) (*ResetDataRes, error) {
...
func _Catalog_ResetData_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(ResetDataReq)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(CatalogServer).ResetData(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: Catalog_ResetData_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(CatalogServer).ResetData(ctx, req.(*ResetDataReq))
	}
	return interceptor(ctx, in, info, handler)
}
...
var Catalog_ServiceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		...
		},
		{
			...
			Handler:    _Catalog_ResetData_Handler,
		},
	},
